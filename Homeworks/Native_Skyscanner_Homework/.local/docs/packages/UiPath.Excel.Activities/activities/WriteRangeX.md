...
|------|-------------|------|------|----------|---------|-------------|
| `Source` | What to write | InArgument | `DataTable` | Yes | | Write Range is intended for writing data from external Data Table sources into Excel. Use the 'Copy or Paste Range' activity when moving data between locations in Excel. |
...
- Use the 'Copy or Paste Range' activity instead when moving data between locations within Excel.
