...
| [Find or Replace Value](activities/FindReplaceValueX.md) | Finds and optionally replaces values in a range |
| [Find First or Last Data Row](activities/FindFirstLastDataRowX.md) | Finds the first and last row with data |
