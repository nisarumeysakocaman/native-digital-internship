...
|------|-------------|------|-------------|
| `SaveTo` | Save to | `OutArgument<DataTable>` | The DataTable where to save the contents of the range. To paste the data from the clipboard use Copy or Paste Range or other dedicated Paste activities. |
